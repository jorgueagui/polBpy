...
def mcmc_fit(disp_funct,lvec,sigma_err,lmin=False,lmax=False,beam=0.0,a2=0.1,delta=1.0,f=1.0,bnds=False,num=500,
             fixed_delta=False,verb=True,mcmc_samples=False):
...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    # Include the MCMC smaples if mcmc_samples = True
    if mcmc_samples == True:
        out = (params,sampler)
    else:
        out = params
